...
<SEO title="What We Do at Keycap: Reviews by Keycap" />

<h1 class="text-3xl font-bold">About Us</h1>

<p>
  Keycap is a list of the best mechanical keyboards and related gear for people
  who want to save the time and stress of figuring out what to buy.
</p>

<p>
  We do our best to thoroughly research every product we review and recommend.
...
<p>
  We pride ourselves on following rigorous journalistic standards and ethics,
...
<p>
  Our only goal is to create engaging content that our readers enjoy. Affiliate
...
<p>
  There are many ways a publisher can make money by providing value to their
...
<p>
  ...
  <em>
    i.e. we collect city/state/country info, but never track IP address or
    geocoordinates).
  </em>
</p>

<p>
  <strong>What if the item I want wasn't on your site?</strong>
</p>

<p>
  Email or tweet at us to let us know if you need help figuring out a particular
